 ...
 * @LastEditTime: 2022-10-08 18:59:52
 * @FilePath: \CsuftSpiderFront\src\pages\Grade\Year\index.tsx
 */
...
import { getYearGrades } from '@/services/ant-design-pro/api';
...
for (let i = 1; i <= 6; i++) {
  ...
  const tmp1: string = year2 + '-' + year1;
  const tmp2: string = year2 + '-' + year1;
    ...
    <>
      <ProTable<API.GradeListItem>
        ...
        request={async (params = {}) => {
          ...
          const data = await getYearGrades({ ...values });
          const gpa1 = data.gpa;
